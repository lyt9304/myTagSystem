            ...
            <div class="row">
                <form class="form-horizontal" id="new-tag-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="tag-name" name="tag-name" placeholder="标签名称" value="<?php echo $tag["name"]?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="tag-href" name="tag-href" placeholder="链接地址" value="<?php echo $tag["href"]?>">
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                            <select name="content-tag[]" id="content-tag" multiple="multiple" class="form-control">
                                ...
                                ?>
                                        ...
                                        <?php
                                            foreach($tag["content_tag"] as $item):
                                                if($item == $v):
                                        ?>
                                                    selected
                                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="star" id="star-yes" value="yes"
                                    <?php if($tag["isStared"]!=0):?>
                                        checked
                                    <?php endif ?>
                                > 是
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="star" id="star-no" value="no"
                                    <?php if($tag["isStared"]==0):?>
                                        checked
                                    <?php endif ?>
                                > 否
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="read" id="read-yes" value="yes"
                                    <?php if($tag["isRead"]!=0):?>
                                        checked
                                    <?php endif ?>
                                > 是
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="read" id="read-no" value="no"
                                    <?php if($tag["isRead"]==0):?>
                                        checked
                                    <?php endif ?>
                                > 否
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="range" name="grade" id="grade" min="0" max="10" step="1" value="<?php echo $tag["grade"]?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="comment" id="comment" cols="30" rows="5"><?php echo $tag["comment"] ?></textarea>
                        </div>
                    </div>
